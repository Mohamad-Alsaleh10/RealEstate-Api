...
">
                    ...
                    @can('manage-admin-resources')
                        ...
                        {{-- قائمة منسدلة لإدارة العقارات والفئات --}}
    <x-dropdown align="right" width="48">
        ...
        <x-slot name="content">
            ...
            <x-dropdown-link :href="route('admin.users.index')"> {{-- New link for User Management --}}
                {{ __('إدارة المستخدمين') }}
            </x-dropdown-link>
            <x-dropdown-link :href="route('admin.ratings.index')"> {{-- New link for Ratings Management --}}
